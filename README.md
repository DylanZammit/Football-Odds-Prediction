...
```rate_j = a_j * d_i```.
The probability of such two teams getting a score of `x-y` is thus
...
### Analysis
In this folder we have notebooks with EDA and model evaluation strategies. This folder is not meant to be deployed to production.
### football_odds
